...
def make_app(settings=None, auth=None, app=None, swagger=True, swagger_ui=True, fs_store=False):
...
def make_local_app():
    from xepmts.api.settings import SOURCE_DIR
    SETTINGS_FILE = os.path.join(SOURCE_DIR, "settings.py")
